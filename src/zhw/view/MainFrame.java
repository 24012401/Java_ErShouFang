/*
 * Created by JFormDesigner on Fri Jan 08 22:12:06 CST 2021
 */

package zhw.view;

import zhw.entity.HouseType;
...
public class MainFrame extends JFrame {
    ...
    private void menuItem6ActionPerformed(ActionEvent e) {
        // TODO add your code here
        HouseTypeManageFrame houseTypeManageFrame = new HouseTypeManageFrame();
        houseTypeManageFrame.setVisible(true);
    }
    ...
    private void menuItem7ActionPerformed(ActionEvent e) {
        // TODO add your code here
        HouseAddFrame houseAddFrame = new HouseAddFrame();
        houseAddFrame.setVisible(true);
    }
    ...
    private void table1MouseClicked(MouseEvent e) {
        ...
        this.idTXT2.setText(table2.getValueAt(row,0).toString());
        this.houseNameTXT.setText(table2.getValueAt(row,1).toString());
        this.houseauthorTXT2.setText(table2.getValueAt(row,2).toString());
        String sex = table2.getValueAt(row,3).toString();
        if("男".equals(sex)){
            this.man2.setSelected(true);
        }else if("女".equals(sex)){
            this.woman2.setSelected(true);
        }
        this.houseDescTXT2.setText(table2.getValueAt(row,5).toString());
        this.priceTXT2.setText(table2.getValueAt(row,6).toString());
        String houseType = table2.getValueAt(row,4).toString();
        int n = this.typeCB2.getItemCount();
        for(int i = 0;i < n;i++){
            HouseType item = (HouseType)this.typeCB2.getItemAt(i);
            if(item.getHouseTypeName().equals(houseType)){
                this.typeCB2.setSelectedIndex(i);
            }
        }
    ...
    private void initComponents() {
        ...
        label15 = new JLabel();
        HouseNameTXT2 = new JTextField();
        label16 = new JLabel();
        priceTXT2 = new JTextField();
        label17 = new JLabel();
        houseauthorTXT2 = new JTextField();
        label18 = new JLabel();
        ...
        //======== panel4 ========
        {
            ...
            panel4.add(HouseNameTXT2);
            HouseNameTXT2.setBounds(320, 20, 130, HouseNameTXT2.getPreferredSize().height);
            ...
            panel4.add(houseauthorTXT2);
            houseauthorTXT2.setBounds(80, 75, 95, houseauthorTXT2.getPreferredSize().height);
            ...
            //======== scrollPane4 ========
            {
                ...
                //---- houseDescTXT2 ----
                houseDescTXT2.setLineWrap(true);
                scrollPane4.setViewportView(houseDescTXT2);
            }
    ...
    private JTextField HouseNameTXT2;
    private JLabel label16;
    private JTextField priceTXT2;
    private JLabel label17;
    private JTextField houseauthorTXT2;
    ...
    private JTextArea houseDescTXT2;
