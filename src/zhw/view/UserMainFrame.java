/*
 * Created by JFormDesigner on Sat Jan 09 21:53:16 CST 2021
 */
    ...
    private void initComponents() {
        ...
        //======== menuBar2 ========
        {
            ...
            //======== menu2 ========
            {
                ...
                //---- menuItem2 ----
                menuItem2.setText("\u6dfb\u52a0\u7684\u623f\u6e90");
                menu2.add(menuItem2);

                //---- menuItem3 ----
                menuItem3.setText("\u7b7e\u8ba2\u7684\u5408\u540c");
                menu2.add(menuItem3);
            }
            menuBar2.add(menu2);
        ...
        //======== panel4 ========
        {
            ...
            //---- buyButton2 ----
            buyButton2.setText("\u8d2d\u4e70");
            buyButton2.addActionListener(e -> updateButtonActionPerformed(e));
            panel4.add(buyButton2);
            buyButton2.setBounds(165, 300, 135, 30);

            //---- addButton2 ----
            addButton2.setText("\u6dfb\u52a0");
            addButton2.addActionListener(e -> delButtonActionPerformed(e));
            panel4.add(addButton2);
            addButton2.setBounds(425, 300, 135, 30);
