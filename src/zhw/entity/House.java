...
/**
 * @auther $张鸿伟
 * @date 2021/1/11 15:12:25
 * @description
 */
public class House implements Serializable {
    private Integer houseId;
    private Integer homeownersId;
    private Integer sellerManId;
    private float price;
    ...
    public Integer getHomeownersId() {
        return homeownersId;
    }

    public void setHomeownersId(Integer homeownersId) {
        this.homeownersId = homeownersId;
    }

    public Integer getSellerManId() {
        return sellerManId;
    }

    public void setSellerManId(Integer sellerManId) {
        this.sellerManId = sellerManId;
    }
    ...
    public void setWrongPlace(String wrongPlace) {
